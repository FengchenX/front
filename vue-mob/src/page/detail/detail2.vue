  ...
  <div id="detail">
    ...
    <div class="content">
      <div class="container" v-swiper:swiperRight='true'>
        ...
        <video class="player" :src="this.url" controls="controls" style="width: 100%;"></video>
        <!-- 热点评论 -->
        <template>
          <!-- 分割线 -->
    ...
    export default {
        ...
        methods: {
            ...
            async handleTitle() {
                ...
                if (index > -1) {
                    this.title = `老常工艺 · ${this.indexColumn[index].classname}`
                }
            },
            // 获取文章数据
            get_Article() {
            ...
            commentBtnClick() {
                this.post_comments_data({id: this.id, user: '', content: this.message}).then()
            },
            /*****************************************************************************/
            // 数据统计
            visitCollect() {
