...
export default {
    ...
    state: {
        ...
        // }],
        /*************************************************/
        indexActive: 'goods',          // active的栏目
        indexPage: { goods: 1 },       // 各个栏目page的对象
        indexLocation: { goods: 0 },   // 各个栏目location的对象
        // 栏目数据
        indexColumn: [{
            classname: '商品',
            classid: 0,
    ...
    actions: {
        ...
        async get_listItem_data({ getters }, page) {
            ...
            /*****************************************************/
            let res = await request('GET', '/topApi/', page)
            /*****************************************************/
            return res
        },
