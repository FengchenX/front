...
<style scoped>
.login{position: fixed; overflow: hidden;left: 50%; margin-left: -250px; top:50%; margin-top: -350px;
  width: 500px; min-height: 555px; z-index: 10; right: 140px; background: #fff;-webkit-border-radius: 5px;
...
.log-cloud{background-image: url(../../assets/images/login/login-cloud.png); width: 63px ;height: 40px; position: absolute; z-index: 1}
...
.log-bg{background: url(../../assets/images/login/login-bg.jpg); width: 100%; height: 312px; overflow: hidden;}
...
.icons{background:url(../../assets/images/login/icons.png) no-repeat; display: inline-block;}
